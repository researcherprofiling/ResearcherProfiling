...
public class RestartSearchButtonListener implements ActionListener{

    private Model model;
    private View view;

    public RestartSearchButtonListener(Model m, View v) {
        model = m;
        view = v;
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        searchConditions.put("feedback", view.getFeedback());
        model.redoSearch(searchConditions);
    }
}
